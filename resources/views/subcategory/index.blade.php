...
<div class="smj-category-page">
    <div class="smj-page-header" style="display: flex; justify-content: space-between; align-items: center;">
        <h1 class="smj-page-title">Manage Sub Categories</h1>
        ...
        <table id="categoryTable" class="subscription-table">
            ...
            <tbody>
                <tr>
                    ...
                    <td>AI</td>
                    <td>
                        <button class="btn-edit" onclick="openEditModal(1, 'Technology', 'AI')">Edit</button>
                ...
                <tr>
                    ...
                    <td>UI/UX</td>
                    <td>
                        <button class="btn-edit" onclick="openEditModal(2, 'Design', 'UI/UX')">Edit</button>
...
<div class="smj-modal-overlay" id="createModal">
    <div class="smj-modal">
        <div class="smj-modal-header">
            <h3 class="smj-modal-title">Create Sub Category</h3>
        ...
        <form class="smj-modal-body" id="createForm">
            ...
            <input type="text" name="subcategory" placeholder="Sub-Category Name" required class="smj-form-input">
        </form>
...
<div class="smj-modal-overlay" id="editModal">
    <div class="smj-modal">
        <div class="smj-modal-header">
            <h3 class="smj-modal-title">Edit Sub Category</h3>
        ...
        <form class="smj-modal-body" id="editForm">
            ...
            <input type="text" id="editSubCategoryName" name="subcategory" placeholder="Sub-Category Name" required class="smj-form-input">
        </form>
        <div class="smj-modal-footer">
...
<script>
    ...
    function openEditModal(id, category, subcategory) {
